...
namespace Elara.Infrastructure.Migrations
{
    ...
    [Migration("20260630021000_AddTeacherInsights")]
    partial class AddTeacherInsights
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Administrative.Announcement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Administrative.DeviceToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Administrative.NotificationPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("AiProgressReports")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                    ...
                    b.Property<bool>("StreakReminders")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Administrative.TeacherInsight", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TeacherInsights", (string)null);
                });
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Chat.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Educational.Homework", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Educational.Module", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Educational.ModuleResource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("SizeOrDurationText")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Educational.ProblemSet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ProblemSetType")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Educational.QuestionOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Educational.Subject", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "PureMathematics",
                            GradeLevel = "Grade12",
                            IsDeleted = false,
                            Name = "PureMathematics"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "AppliedMathematics",
                            GradeLevel = "Grade12",
                            IsDeleted = false,
                            Name = "AppliedMathematics"
                        },
                        new
                        {
                            Id = 6,
            ...
            modelBuilder.Entity("Elara.Domain.Entities.JunctionTables.HomeworkVideo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("HomeworkId", "VideoId")
                        .IsUnique()
                        .HasDatabaseName("IX_HomeworkVideos_HomeworkId_VideoId");

                    b.ToTable("HomeworkVideos", (string)null);
                });
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Submissions.QuizAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Submissions.QuizSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ElaraInsight")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Submissions.StudentSubmission", b =>
                {
                    ...
                    b.HasIndex("StudentId", "ProblemSetId")
                        .HasDatabaseName("IX_StudentSubmissions_StudentId_ProblemSetId");

                    b.ToTable("StudentSubmissions", (string)null);
                });

            modelBuilder.Entity("Elara.Domain.Entities.Submissions.StudentSubmissionAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("StudentSubmissionAnswers");
                });
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Educational.Homework", b =>
                {
                    b.HasOne("Elara.Domain.Entities.Educational.Module", "Module")
                        .WithMany("Homeworks")
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Educational.ProblemSet", b =>
                {
                    b.HasOne("Elara.Domain.Entities.Educational.Homework", "Homework")
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Educational.Question", b =>
                {
                    b.HasOne("Elara.Domain.Entities.Educational.ProblemSet", "ProblemSet")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Submissions.QuizAnswer", b =>
                {
                    b.HasOne("Elara.Domain.Entities.Submissions.QuizSession", "QuizSession")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("Elara.Domain.Entities.Submissions.StudentSubmissionAnswer", b =>
                {
                    ...
                    b.HasOne("Elara.Domain.Entities.Submissions.StudentSubmission", "Submission")
                        .WithMany("Answers")
