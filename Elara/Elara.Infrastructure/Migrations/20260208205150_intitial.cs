        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotificationDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AverageScore = table.Column<double>(type: "double precision", precision: 5, scale: 2, nullable: false, defaultValue: 0.0),
                    ImprovementTips = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    WeakAreas = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    StrengthAreas = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    Summary = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    TotalAssignmentsCompleted = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    TotalHintsUsed = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    CompletionRate = table.Column<double>(type: "double precision", precision: 5, scale: 2, nullable: false, defaultValue: 0.0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    GradeLevel = table.Column<string>(type: "text", nullable: false),
                    LearningLevel = table.Column<int>(type: "integer", maxLength: 50, nullable: false, defaultValue: 1),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Roadmaps_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Roadmaps_Teachers_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Classes_Roadmaps_RoadmapId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AIFeedback = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    StudentId = table.Column<Guid>(type: "uuid", nullable: false),
                    AssignmentId = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAIGenerated = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    HintLevel = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Roadmaps_Grade_SubjectId",
                table: "Roadmaps",
                columns: new[] { "Grade", "SubjectId" });

            migrationBuilder.CreateIndex(
                name: "IX_Roadmaps_IsDeleted",
                table: "Roadmaps",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Roadmaps_SubjectId",
                table: "Roadmaps",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Roadmaps_TeacherId",
                table: "Roadmaps",
                column: "TeacherId");
